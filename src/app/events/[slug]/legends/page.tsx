...
export default async function EventLegendsPage({
  params,
}: {
      ...
      <SectionHeader
        ...
        description={
          eventLegends.length > 0
            ? "Moments and figures etched into Bundesliga lore."
      ...
      {eventLegends.length > 0 && eventLegends.length < legends.length ? (
        <div className="mt-14">
          <SectionHeader
            ...
            description="Players and eras from clubs competing under the Bundesliga mark this week."
          />
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
            {legends

...
export const matches: Match[] = [
  ...
  },
  {
    ...
    homeLineupIds: [
      "player-hradecky",
      "player-leverkusen-lb",
      "player-leverkusen-cb1",
      "player-leverkusen-cb2",
      "player-leverkusen-rb",
      "player-leverkusen-lm",
      "player-leverkusen-cm1",
      "player-leverkusen-cm2",
      "player-leverkusen-rm",
      "player-wirtz",
      "player-boniface"
    ],
    awayLineupIds: [
  ...
  {
    id: "match-dortmund-leverkusen",
    slug: "dortmund-vs-leverkusen",
    eventId: "evt-bundesliga",
    sport: "football",
    round: "Matchday 14",
    status: "scheduled",
    kickoff: "2025-11-22T18:30:00+01:00",
    homeTeamId: "team-dortmund-fc",
    awayTeamId: "team-leverkusen-fc",
    homeScore: 0,
    awayScore: 0,
    venue: "Signal Iduna Park",
    events: [],
  ...
  {
    id: "match-dortmund-stuttgart",
    slug: "dortmund-vs-stuttgart",
    eventId: "evt-bundesliga",
    sport: "football",
    round: "Matchday 15",
    status: "scheduled",
    kickoff: "2025-11-29T15:30:00+01:00",
    homeTeamId: "team-dortmund-fc",
    awayTeamId: "team-stuttgart-fc",
    homeScore: 0,
    awayScore: 0,
    venue: "Signal Iduna Park",
    events: [],
  ...
  {
    id: "match-werder-leipzig",
    slug: "werder-vs-leipzig",
    eventId: "evt-bundesliga",
    sport: "football",
    round: "Matchday 13",
    status: "scheduled",
    kickoff: "2025-11-16T17:30:00+01:00",
    homeTeamId: "team-werder-fc",
    awayTeamId: "team-leipzig-fc",
    homeScore: 0,
    awayScore: 0,
  ...
  {
    id: "match-werder-freiburg",
    slug: "werder-vs-freiburg",
    eventId: "evt-bundesliga",
    sport: "football",
    round: "Matchday 14",
    status: "scheduled",
    kickoff: "2025-11-23T15:30:00+01:00",
    homeTeamId: "team-werder-fc",
    awayTeamId: "team-freiburg-fc",
    homeScore: 0,
    awayScore: 0,
  ...
  {
    id: "match-dortmund-pulse-socca",
    slug: "dortmund-socca-vs-vienna-pulse",
    eventId: "evt-socca-austria-pro",
    sport: "socca",
    round: "Round 10",
    status: "scheduled",
    kickoff: "2025-03-28T19:00:00+01:00",
    homeTeamId: "team-dortmund-socca",
    awayTeamId: "team-vienna-pulse-socca",
    homeScore: 0,
    awayScore: 0,
    venue: "Vienna Arena Cage B",
    events: [],
  ...
  {
    id: "match-lorient-pulse-socca",
    slug: "lorient-socca-vs-vienna-pulse",
    eventId: "evt-socca-austria-pro",
    sport: "socca",
    round: "Round 10",
    status: "scheduled",
    kickoff: "2025-03-29T17:00:00+01:00",
    homeTeamId: "team-lorient-socca",
    awayTeamId: "team-vienna-pulse-socca",
    homeScore: 0,
    awayScore: 0,
    venue: "Vienna Arena Cage A",
